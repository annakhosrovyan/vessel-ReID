...
class BaseImageDataset(BaseDataset):
    ...
    def print_dataset_statistics(self, train, query, gallery, query_val, gallery_val):
        ...
        num_query_val_pids, num_query_val_imgs, num_query_val_cams, _ = self.get_imagedata_info(query_val)
        num_gallery_val_pids, num_gallery_val_imgs, num_gallery_val_cams, _ = self.get_imagedata_info(gallery_val)
        ...
        print("  ----------------------------------------")
        print("  query_val| {:5d} | {:8d} | {:9d}".format(num_query_val_pids, num_query_val_imgs, num_query_val_cams))
        print("  gallery_val| {:4d} | {:8d} | {:9d}".format(num_gallery_val_pids, num_gallery_val_imgs, num_gallery_val_cams))
        print("  ----------------------------------------")
